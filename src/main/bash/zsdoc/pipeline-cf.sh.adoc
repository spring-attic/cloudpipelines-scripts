...
_Environment variables used:_ pipeline-k8s.sh -> APPLICATION_URL
...
_Environment variables used:_ pipeline-k8s.sh -> APPLICATION_URL [big]*//* pipeline-k8s.sh -> STUBRUNNER_URL [big]*//* pipeline.sh -> LATEST_PROD_TAG [big]*//* pipeline.sh -> OUTPUT_FOLDER
...
Called by:
 ...
 deployAppAsService
 deployStubRunnerBoot
 pipeline-k8s.sh/deployAndRestartAppWithName
...
_Environment variables used:_ pipeline-k8s.sh -> APPLICATION_URL [big]*//* pipeline.sh -> OUTPUT_FOLDER
